...
window.onload = function() {
    ...
    if (storedName) {
        ...
        if(topBar) topBar.style.display = 'flex'; // SHOW home/exit
        if (storedName === "Admin") activateAdminMode(); else deactivateAdminMode();
    } else {
        document.getElementById("nameModal").classList.remove("hidden");
        if(topBar) topBar.style.display = 'none'; // HIDE home/exit
    }
...
function saveGuestName() {
    ...
    document.getElementById("nameModal").classList.add("hidden");
    document.querySelector('.header-top-bar').style.display = 'flex'; // SHOW home/exit
    deactivateAdminMode();
}
...
function openLightbox(postElement, index) {
    ...
    const mediaElements = postElement.querySelectorAll('.post-media-item');
...
function setupEventListeners(){
    ...
    // NEW: HOME & EXIT BUTTONS
    document.getElementById('homeBtn').addEventListener('click', () => {
        window.location.href = "index.html"; // balik sa main wedding invite
    });

    document.getElementById('exitBtn').addEventListener('click', () => {
        sessionStorage.removeItem("weddingGuestName"); // clear name
        document.getElementById("nameModal").classList.remove("hidden"); // show popup ulit
        document.querySelector('.header-top-bar').style.display = 'none'; // HIDE home/exit
    });
